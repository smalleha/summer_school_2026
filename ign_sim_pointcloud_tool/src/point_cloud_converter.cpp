...
: rclcpp::Node("point_cloud_converter", options)
{
  ...
  this->declare_parameter<int>("n_scan", 50);
  this->declare_parameter<int>("horizon_scan", 360);
  this->declare_parameter<float>("ang_bottom", 7.22);
  this->declare_parameter<float>("ang_res_y", 1.248);
