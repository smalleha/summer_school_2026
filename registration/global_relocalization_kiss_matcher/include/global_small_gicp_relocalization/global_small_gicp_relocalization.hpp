#ifndef GLOBAL_SMALL_GICP_RELOCALIZATION_HPP_
#define GLOBAL_SMALL_GICP_RELOCALIZATION_HPP_
...
class GlobalSmallGicpRelocalizationNode : public rclcpp::Node
{
public:
  explicit GlobalSmallGicpRelocalizationNode(const rclcpp::NodeOptions & options);
...
#endif  // GLOBAL_SMALL_GICP_RELOCALIZATION_HPP_
