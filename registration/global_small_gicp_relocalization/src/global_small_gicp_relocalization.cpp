  ...
  previous_result_t_(Eigen::Isometry3d::Identity())
{
  ...
  this->declare_parameter("coarse_leaf_size", 0.8); // 粗配准体素盒子
  this->declare_parameter("medium_leaf_size", 0.5); // 中配准体素盒子
  this->declare_parameter("fine_leaf_size", 0.25);  // 细配准体素盒子
  ...
  // 预处理粗配准、中配准、细配准使用的 target 点云和 KdTree
